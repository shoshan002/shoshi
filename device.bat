...
@REM adb shell am start -a android.intent.action.CALL -d tel:+918277302599
@REM adb shell input tap 136 2200

@REM adb shell input text "shoshan%shello"
@REM PS C:\Users\nishv\OneDrive\Desktop\platform-tools-latest-windows (1)\platform-tools> adb shell input keyevent 3